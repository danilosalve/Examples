...
aAdd( aSX2, { ;
	...
	'Casos de Teste'														, ; //X2_NOME
	'Casos de Teste'														, ; //X2_NOMESPA
	'Test Case'																, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
	'ZA_FILIAL + ZA_PROG + ZA_COD'											, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	''																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'IIF(EMPTY(M->ZA_COD),.T.,ExistChav("SZA",M->ZA_PROG+M->ZA_COD))'		, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'Test Case'																, ; //X3_TITSPA
	'Test Case'																, ; //X3_TITENG
	'Caso de Teste'															, ; //X3_DESCRIC
	'Caso de Teste'															, ; //X3_DESCSPA
	'Caso de Teste'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'IIF(EMPTY(M->ZA_PROG),.T.,ExistChav("SZA",M->ZA_PROG+M->ZA_COD))'		, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'Pertence("AORV")'														, ; //X3_VLDUSER
	'A=Automatizado;O=Obsoleto;R=Rascunho;V=Revisar'						, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSIX, { ;
	'SZA'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZA_FILIAL+ZA_PROG+ZA_COD'												, ; //CHAVE
	'Programa+Test Case'													, ; //DESCRICAO
	'Programa+Test Case'													, ; //DESCSPA
	'Programa+Test Case'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Informe o programa' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZA_PROG   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZA_PROG" )

aHlpPor := {}
aAdd( aHlpPor, 'Informe o codigo do Caso de Teste' )
aHlpEng := {}
aHlpSpa := {}
